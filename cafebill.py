...
root = Tk()
root.geometry("980x580+0+0")
root.title("HOSPITAL MANAGMENT SYSTEM")

Tops = Frame(root,bg="gray85",width = 1600,height=50,relief=SUNKEN)
Tops.pack(side=TOP)
...
lblinfo = Label(Tops, font=( 'aria' ,30, 'bold' ),text="HOSPITAL BILLING SYSTEM",fg="saddle brown",bd=10,anchor='w')
lblinfo.grid(row=0,column=0)
lblinfo = Label(Tops, font=( 'aria' ,20, ),text=localtime,fg="snow4",anchor=W)
...
def Ref():
    ...
    cof =float(BLOOD_TEST.get())
    colfries= float(SUGAR_TEST.get())
    cob= float(ECG.get())
    cofi= float(GENERAL_CHECK_UP.get())
    cochee= float(ENT.get())
    codr= float(DERMOTOLOGY.get())

    costoffries = cof*250
    costoflargefries = colfries*400
    costofburger = cob*3500
    costoffilet = cofi*500
    costofcheeseburger = cochee*3000
...
lblfries = Label(f1, font=( 'aria' ,16, 'bold' ),text=" BLOOD TEST ",fg="blue",bd=10,anchor='w')
...
lblLargefries = Label(f1, font=( 'aria' ,16, 'bold' ),text="SUGAR TEST",fg="blue",bd=10,anchor='w')
...
lblburger = Label(f1, font=( 'aria' ,16, 'bold' ),text="ECG ",fg="blue",bd=10,anchor='w')
...
lblFilet = Label(f1, font=( 'aria' ,16, 'bold' ),text="GENERAL CHECK UP ",fg="blue",bd=10,anchor='w')
...
lblCheese_burger = Label(f1, font=( 'aria' ,16, 'bold' ),text="ENT",fg="blue",bd=10,anchor='w')
...
#--------------------------------------------------------------------------------------
lblDrinks = Label(f1, font=( 'aria' ,16, 'bold' ),text="DERMOTOLOGY",fg="blue",bd=10,anchor='w')
...
def price():
    ...
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="CATALOG", fg="black", bd=5)
    lblinfo.grid(row=0, column=0)
    lblinfo = Label(roo, font=('aria', 15,'bold'), text="_____________", fg="white", anchor=W)
    lblinfo.grid(row=0, column=2)
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="PRICE", fg="black", anchor=W)
    lblinfo.grid(row=0, column=3)
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="BLOOD TEST", fg="steel blue", anchor=W)
    lblinfo.grid(row=1, column=0)
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="250", fg="steel blue", anchor=W)
    lblinfo.grid(row=1, column=3)
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="SUGAR TEST ", fg="steel blue", anchor=W)
    lblinfo.grid(row=2, column=0)
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="400", fg="steel blue", anchor=W)
    lblinfo.grid(row=2, column=3)
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="ECG ", fg="steel blue", anchor=W)
    lblinfo.grid(row=3, column=0)
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="3500", fg="steel blue", anchor=W)
    lblinfo.grid(row=3, column=3)
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="GENERAL CHECK UP ", fg="steel blue", anchor=W)
    lblinfo.grid(row=4, column=0)
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="500", fg="steel blue", anchor=W)
    lblinfo.grid(row=4, column=3)
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="ENT ", fg="steel blue", anchor=W)
    lblinfo.grid(row=5, column=0)
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="3000", fg="steel blue", anchor=W)
    lblinfo.grid(row=5, column=3)
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="DERMOTOLOGY", fg="steel blue", anchor=W)
